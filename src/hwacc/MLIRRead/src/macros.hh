#ifndef MLIR_MACROS_HH
#define MLIR_MACROS_HH
...
// MLIR arith.cmpf comparison codes
enum CmpFPredicate : unsigned {
    FCMP_FALSE = 0,   // AlwaysFalse
    FCMP_OEQ = 1,     // oeq
    FCMP_OGT = 2,     // ogt
    FCMP_OGE = 3,     // oge
    FCMP_OLT = 4,     // olt
    ...
    FCMP_UNE = 13,    // une
    FCMP_UNO = 14,    // uno
    FCMP_TRUE = 15    // AlwaysTrue
};

enum CmpIPredicate : unsigned {
    ICMP_EQ  = 0,   // eq
    ICMP_NE  = 1,   // ne
    ICMP_SLT = 2,   // slt
    ICMP_SLE = 3,   // sle
