#ifndef MLIRREAD_DEBUG_HH
#define MLIRREAD_DEBUG_HH
// License 
 ...
 * implementation of the Debugger class used within gem5-MULA. 
 */
...
/**
 * @class Debugger
 * Base implementation of the debugger used in gem5-MULA
 */
class Debugger
{
    private:
